...
def main():
    ...
    keypoint_classifier = KeyPointClassifier(model_path='keypoint_classifier.tflite')
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                debug_image = draw_info_text(debug_image, brect, handedness.classification[0].label, keypoint_classifier_labels[hand_sign_id])
